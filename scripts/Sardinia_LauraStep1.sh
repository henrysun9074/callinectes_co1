...
#SBATCH --job-name=Pre_Template_job
#SBATCH --account=schultzlab -p schultzlab
#SBATCH --array=01-48
#SBATCH --output=/work/tfs3/Callinectes/rerun/step1.out
#SBATCH --error=/work/tfs3/Callinectes/rerun/step1.err
#SBATCH --ntasks=10
#SBATCH --mail-type=ALL
#SBATCH --mail-user=hs325@duke.edu

# the fastest way to rename paths in this script is to Find "/work/tfs3/Callinectes/RERUN" and Replace it with what corresponds to your "/work/NETID/RUN1" # 
...
## transferred to DCC /work/tfs3/Callinectes/RERUN/fastq_pass
## file_list.txt transferred to DCC /work/tfs3/Callinectes/RERUN

# --------------------------------------- To Do --------------------------------------- #
# change the following
d="/work/tfs3/Callinectes/rerun" #direct computer to where the fastq_pass folder is stored
