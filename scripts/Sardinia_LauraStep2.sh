...
#SBATCH --job-name=CDHIT_Template
#SBATCH --account=schultzlab -p schultzlab
#SBATCH --array=01-48%5
#SBATCH --output=/work/tfs3/Callinectes/rerun/outfile/outfileCDHIT/CDHIT_Template_array.%A_%a.out
#SBATCH --error=/work/tfs3/Callinectes/rerun/outfile/outfileCDHIT/CDHIT_Template_array.%A_%a.err
#SBATCH --ntasks=10
#SBATCH --mem=15G
...
d="/work/tfs3/Callinectes/rerun"
clustering=0.95 #max=1
clusteringlong=95
mincluster=2 #change this
maxseq=300000
