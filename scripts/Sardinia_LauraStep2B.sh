...
#SBATCH --job-name=2Cluster_TEMPLATE
#SBATCH --account=schultzlab -p schultzlab,nsoe-it,common
#SBATCH --array=01-48%5
#SBATCH --output=/work/tfs3/Callinectes/outfile/SecondaryCluster_TEMPLATE.%A_%a.out
#SBATCH --error=/work/tfs3/Callinectes/outfile/SecondaryCluster_TEMPLATE.%A_%a.err
#SBATCH --mem=15G
