...
#SBATCH --job-name=seqtabqiimeTemplate_min
#SBATCH --account=schultzlab -p schultzlab
#SBATCH --output=/work/tfs3/Callinectes/outfile/seqtabqiimeTemplate_min.out
#SBATCH --error=/work/tfs3/Callinectes/outfile/seqtabqiimeTemplate_min.err
#SBATCH --ntasks=10
#SBATCH --mem=15G
